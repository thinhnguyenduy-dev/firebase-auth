...
interface SocialLoginButtonsProps {
  onSocialLogin: (provider: AuthProvider, providerName: string) => void;
  disabled?: boolean;
}

/**
 * Reusable social login buttons grid component.
 * Supports Google, Facebook, Microsoft, and Apple providers.
 */
export default function SocialLoginButtons({ onSocialLogin, disabled }: SocialLoginButtonsProps) {
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      <button
        onClick={() => onSocialLogin(microsoftProvider, 'Microsoft')}
        disabled={disabled}
      ...
      <button
        onClick={() => onSocialLogin(appleProvider, 'Apple')}
        disabled={disabled}
